...
contenidos=[["Cenicienta","Caperucita", "Hansel y Gretel","Pinocho","El patito feo", "Blancanieves", "Los tres cerditos"],
...
["rojo","amarillo","azul","naranja","verde","violeta","magenta","cian"]]
...
# match opcion:
#   case 1:
#    print(f"La Categoria seleccionada es {Categorias[0]}")
#   case 2:
#    print(f"La Categoria seleccionada es {Categorias[1]}")
#   case 3:
#    print(f"La Categoria seleccionada es {Categorias[2]}")
#   case 4:
#    print(f"La Categoria seleccionada es {Categorias[3]}")
...
#falta el tiempo y arreglar en gral  😹    